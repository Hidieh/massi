...
/*********
 * Custom post types: Tapahtumat ja Suunnitelmat
 ************/
function create_post_type() {
    register_post_type( 'tapahtuma',
        array(
            'labels' => array(
                'name' => __( 'Tapahtumat' ),
    ...
    register_post_type( 'suunnitelma',
        array(
            'labels' => array(
                'name' => __( 'Suunnitelmat' ),
                'singular_name' => __( 'Suunnitelma' )
            ),
            'public' => true,
            'has_archive' => true,
        )
